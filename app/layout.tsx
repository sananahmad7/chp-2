...
import { BookingModalProvider } from "@/components/shared/booking-modal-provider";
    ...
    <html lang="en" className="scroll-smooth motion-reduce:scroll-auto">
      ...
      >
        ...
        <div className="fixed inset-0 -z-10">
          ...
          <div className="absolute inset-0 bg-[linear-gradient(to_right,rgb(var(--brand-rgb)/.28)_1px,transparent_1px),linear-gradient(to_bottom,rgb(var(--brand-rgb)/.28)_1px,transparent_1px)] bg-[size:56px_56px] opacity-[0.06] [mask-image:radial-gradient(75%_55%_at_50%_25%,black,transparent)]" />
        </div>

        {/* Skip link */}
        <a
          href="#main"
          className="sr-only z-[100] rounded bg-[var(--surface)] px-3 py-2 text-sm ring-2 ring-[var(--accent-color)] focus:not-sr-only focus:absolute focus:left-4 focus:top-4"
        >
          Skip to content
        </a>
